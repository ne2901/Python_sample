...
class CandidateForm(forms.ModelForm):
    class Meta:
        model = Candidate
        fields = ('candidate_name', 'job_title', 'experience', 'highest_degree', 'city', 'country', 'source', 'email',
                  'contact_number', 'screening_score_1', 'status_1', )

# 'screening_score_2', 'status_2', 'final_schedule', 'screening_score_3', 'status_3', 'final_score',
